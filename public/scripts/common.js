...
//             const inLatBoundary = (MUSEUM.latitude - offset <= lat && lat <= MUSEUM.latitude + offset);
//             const inLongBoundary = (MUSEUM.longitude - offset <= long && long <= MUSEUM.longitude + offset);
